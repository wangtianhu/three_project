...
import { SpinControls } from './SpinControls.js'
...
let CameraSpinControls = function (camera, domElement) {
        ...
        return function adjustTrackballRadius() {
            if (scope.object.isPerspectiveCamera) {
                ...
                scope.spinControl.trackballRadius =
                    TRACKBALL_PERCENT_OF_SCREEN *
                    v.length() *
                    distanceToScreenSize
            } else {
